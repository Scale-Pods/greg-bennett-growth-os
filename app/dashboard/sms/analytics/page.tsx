        ...
        <div className="space-y-4 pb-4 relative min-h-[500px]">
            ...
            <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <StatCard title="Total Replies" value={loading ? "..." : stats.totalReplies.toLocaleString()} icon={MessageSquare} color="#D6336C" info="Derived from SMS replied tracking columns." />
            ...
            <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <StatCard title="Generated Replies" value={loading ? "..." : stats.ownerReplies.toLocaleString()} icon={Reply} color="#D6336C" />
                            ...
                            <AreaChart data={stats.trendData}>
                                <defs>
                                    ...
                                    <linearGradient id="colorReplied" x1="0" y1="0" x2="0" y2="1">
                                        <stop offset="5%" stopColor="#D6336C" stopOpacity={0.15} />
                                ...
                                <Area type="monotone" dataKey="sent" name="Reachouts" stroke="#3B5BDB" strokeWidth={2} fill="url(#colorSent)" />
                                <Area type="monotone" dataKey="replied" name="Replies" stroke="#D6336C" strokeWidth={2} fill="url(#colorReplied)" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                        ...
                        <div style={{ height: 240, width: '100%' }}>
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={loopBreakdown} layout="vertical" margin={{ left: 8, right: 16 }}>
                                    ...
                                    <Bar dataKey="reachouts" name="Reachouts" fill="#3B5BDB" radius={[0, 4, 4, 0]} barSize={14} />
                                    <Bar dataKey="replied" name="Replied" fill="#D6336C" radius={[0, 4, 4, 0]} barSize={14} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                    )}
                        ...
                        <tbody>
                            {loopBreakdown.map(row => (
                                ...
                                >
                                    ...
                                    <td style={{ padding: '12px 16px', textAlign: 'center', fontSize: 13, fontWeight: 600, color: '#D6336C' }}>{row.replied.toLocaleString()}</td>
