                    ...
                    <Card className="border-slate-200">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input defaultValue="Senior Consultant at Bennett Growth OS" />
                            </div>
                            <div className="grid gap-2">
                                <Label>Opening Greeting</Label>
                                <Input defaultValue="Hello, this is Fatima from Bennett Growth OS. I noticed you were interested in our solutions." />
                            </div>
                        </CardContent>
                    </Card>
                </TabsContent>
