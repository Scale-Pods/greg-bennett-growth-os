    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-8 right-8 z-40 h-14 w-14 rounded-full bg-emerald-500 hover:bg-emerald-400 active:scale-95 text-white shadow-[0_0_30px_-5px_rgba(15,157,88,0.7)] transition-all duration-200 flex items-center justify-center group"
                            ...
                            <div className="flex items-center justify-center gap-4">
                                ...
                                {isInCall ? (
                                    ...
                                    <button
                                        ...
                                        className="h-16 w-16 rounded-full bg-emerald-500 hover:bg-emerald-400 active:scale-95 disabled:opacity-25 disabled:cursor-not-allowed flex items-center justify-center shadow-[0_0_25px_-5px_rgba(15,157,88,0.6)] transition-all"
