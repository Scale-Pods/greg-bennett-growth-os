...
export const ResetPasswordEmail: React.FC<Readonly<ResetPasswordEmailProps>> = ({
    ...
    <div style={{
        ...
        <div style={{ marginBottom: '30px' }}>
            <img
                src="https://bennettgrowthos.ai/logo.png"
                alt="Bennett Growth OS"
        ...
        <p style={{ color: '#a1a1aa', fontSize: '16px', lineHeight: '1.5', marginBottom: '30px' }}>
            Hello {fullName},<br />
            We received a request to reset the password for your Bennett Growth OS account.
        </p>
        ...
        <div style={{
            ...
            © 2026 Bennett Growth OS. Powered by ScalePods.
        </div>
    </div>
);
