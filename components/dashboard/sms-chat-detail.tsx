    ...
    if (loading) {
        return (
            <div style={{ height: 440, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12, color: 'var(--label-tertiary)' }}>
                <RefreshCw style={{ width: 20, height: 20, color: '#D6336C' }} className="animate-spin" />
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <button
                        ...
                        style={{
                            ...
                            background: isTranslated ? 'rgba(214,51,108,0.10)' : 'var(--fill-tertiary)',
                            border: `1px solid ${isTranslated ? 'rgba(214,51,108,0.25)' : 'var(--glass-border)'}`,
                            color: isTranslated ? '#D6336C' : 'var(--label-primary)',
                        }}
                    >
                        {isTranslating
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: copied ? 'rgba(48,209,88,0.15)' : '#D6336C',
                        ...
                        {messages.length === 0 ? (
                            ...
                            messages.map((msg, idx) => {
                                ...
                                if (msg.type === 'bot' && (msg as any).tsStatus) {
                                    ...
                                    if (formatted.includes('Read')) { pillBg = 'rgba(214,51,108,0.10)'; pillColor = '#D6336C'; }
